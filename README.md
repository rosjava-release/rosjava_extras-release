## rosjava_extras (kinetic) - 0.3.2-0

The packages in the `rosjava_extras` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release rosjava_extras --rosdistro kinetic --track kinetic` on `Mon, 29 May 2017 12:26:55 -0000`
...
## rosjava_extras (kinetic) - 0.3.1-0
